...
XCoinAPI.setKey = function(api_key, api_secret){
	this.apiUrl = 'https://api.bithumb.com';
	this.api_key = api_key;
	this.api_secret = api_secret;
}

XCoinAPI.xcoinApiCall = function(endPoint, params, callback) {
	var rgParams = {
		'endPoint' : endPoint
	};
	...
	this.request(api_host, 'POST', rgParams, httpHeaders, function(err, body) {			
		callback(null, body.data);
	});
}

XCoinAPI.request = function(strHost, strMethod, rgParams, httpHeaders, callback) {
	var rgHeaders = {};
	if(httpHeaders) {
	...
	function(error, response, rgResult) {
		...
		callback(null,JSON.parse(rgResult));	
	});
}


XCoinAPI._getHttpHeaders = function(endPoint, rgParams, api_key, api_secret) {
